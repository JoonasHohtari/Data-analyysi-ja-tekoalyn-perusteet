...
history=model.fit(X_train, y_train.values, epochs=200, batch_size=10, validation_data=(X_test,y_test.values))
...
plt.legend()
plt.ylim(bottom=0, top=5 * min(history.history['val_accuracy']))
plt.show()
